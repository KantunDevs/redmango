    ...
    <OuterWrapper ref={ref}>
      <MaxWidthWrapper>
        <Container>
          ...
          <CopyrightSection>
            <Disclaimer>
              <Copyright>© 2020 - 2023 Red Mango, LLC. All Rights Reserved</Copyright>
              <Trademark>RED MANGO name, design and related marks are trademarks of Red Mango, LLC</Trademark>
            </Disclaimer>
          </CopyrightSection>
          <TermsAndConditions>
